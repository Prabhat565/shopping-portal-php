...
<body onload="totala()">
    ...
    <section id="cart-add" class="section-p1">
        ...
        <div id="subtotal">
            ...
            <table>
                <tr>
                    <td>Cart Subtotal</td>
                    <td id='tot1' onload="totala()">Rs. </td>
                </tr>
                <tr>
                    <td>Shipping</td>
                    <td>Free</td>
                ...
                <tr>
                    ...
                    <td id='tot' onload="totala()"><strong>Rs. </strong></td>
                </tr>
            </table>
    ...
    <footer class="section-p1">
        <div class="col">
            ...
            <h4>Contact</h4>
            <p>
                <strong>Address: </strong> LPU, Phagwara, Punjab, India

            </p>
            <p>
                <strong>Phone: </strong> +917894563210
            </p>
            <p>
...
function subprice() {
    ...
    for (var i = 0; i < qty.length; i++) {
        ...
        sub[i].innerHTML = `Rs. ${quantity * price}`;
...
function totala() {
    ...
    document.getElementById('tot').innerHTML = 'Rs.' + yes;
    document.getElementById('tot1').innerHTML = 'Rs.' + yes;
}
</script>
